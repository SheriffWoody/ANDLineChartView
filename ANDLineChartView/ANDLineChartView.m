...
{
    if(_dataSource && [_dataSource respondsToSelector:@selector(chartView:descriptionForForElementAtRow:)]){
        return [_dataSource chartView:self descriptionForForElementAtRow:row];
    }else{
        NSAssert(_dataSource, @"Data source is not set.");
        NSAssert([_dataSource respondsToSelector:@selector(chartView:descriptionForForElementAtRow:)], @"chartView:descriptionForForElementAtRow: not implemented.");
        return @"";
    }
}
@end
